...
import { LuArrowBigLeft, LuArrowLeftToLine, LuArrowRightFromLine, LuHome, LuMessageSquare, LuNetwork, LuTrophy, LuUser, LuUsers, LuUserSquare, LuWallet } from "react-icons/lu";
...
export const adminMenus = [
  ...
  { key: "admin_comment", icon: <LuMessageSquare />, label: "Comment", path: "/admin/comment" },
