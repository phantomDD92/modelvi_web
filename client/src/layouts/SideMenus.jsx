...
export const agencyMenus = [
  ...
  { key: "guide", icon: <LuBook size={24} />, label: <Link to="/guide">Guide</Link> },
  { key: "model", icon: <LuUser size={24} />, label: <Link to="/model">Model</Link> },
  { key: "account", icon: <LuSquareUser size={24} />, label: <Link to="/account/F2F">Account</Link> },
...
export const adminMenus = [
  { key: "admin_dashboard", icon: <LuHouse size={24}/>, label: <Link to="/admin">Dashboard</Link> },
  {
    key: "admin_post", icon: <LuArchive size={24}/>, label: "Post Bot", children: [
      { key: "admin_model", icon: <LuUser size={24} />, label: <Link to="/admin/model">Model</Link> },
      { key: "admin_account", icon: <LuSquareUser size={24} />, label: <Link to="/admin/account/F2F">Account</Link> },
      { key: "admin_schedule", icon: <LuSatellite size={24} />, label: <Link to="/admin/schedule">Schedule</Link> },
      // { key: "admin_proxy", icon: <LuNetwork size={24} />, label: <Link to="/admin/proxy">Proxy</Link> },
      { key: "admin_chat", icon: <LuMessageSquare size={24} />, label: <Link to="/admin/chat">Chat Team</Link> },
    ]
  },
  {
    key: "admin_like", icon: <LuThumbsUp size={24} />, label: "Like Bot", children: [
      { key: "admin_like_account", icon: <LuSquareUser size={24} />, label: <Link to="/admin/like/FANLIKE" >Account</Link> },
      { key: "admin_like_comment", icon: <LuMessageSquareDashed size={24} />, label: <Link to="/admin/like_comment" >Comment</Link> },
    ]
  },
  { key: "admin_agency", icon: <LuUsers size={24} />, label: <Link to="/admin/agency">Agency</Link> },
  { key: "admin_proxy", icon: <LuNetwork size={24} />, label: <Link to="/admin/proxy">Proxy</Link> },
  { key: "admin_finance", icon: <LuWallet size={24} />, label: <Link to="/admin/finance/payments">Finance</Link> },
  { key: "admin_affiliate", icon: <LuTrophy size={24} />, label: <Link to="/admin/affiliate">Affiliate</Link> },
  { key: "to_agency", icon: <LuArrowLeftToLine size={24} />, label: <Link to="/dashboard">To Agency</Link> },
]