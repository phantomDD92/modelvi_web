...
import { loadBlockUsers, loadComments } from "@/redux/v2/actions";
...
const AccountParamDialog = ({ open, account, onCancel, onUpdate }) => {
    ...
    }, [open, account, loadComments, loadBlockUsers, dispatch]);
                ...
                {hasCommentSupport(account?.platform) &&
                    <>
                        ...
                        <Form.Item
                            ...
                            <Link to={"/comment"}>{blockUsers.length} Users Blocked</Link> :
                        </Form.Item>
                        <Form.Item
                            // name="commentLists"
                            label="Comments List">
                            <Link to={"/comment"}>{comments.length} Comments Available</Link> :
                        </Form.Item>
                    </>
                }
