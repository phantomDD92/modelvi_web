...
const AffiliateCommissionChart = ({ time, dataSource, onTimeChange }) => {
  ...
  const getSeries = (time, data) => {
    ...
    switch (time) {
      case "day":
        commissionData = new Array(16).fill(0);
        startDate = moment().startOf("day").subtract(15, "day");
        break
      case "week":
        commissionData = new Array(11).fill(0);
        startDate = moment().startOf("week").subtract(10, "week");
        break
      case "month":
        commissionData = new Array(13).fill(0);
        startDate = moment().startOf("month").subtract(12, "month");
        break
      default:
        commissionData = new Array(65).fill(0);
        startDate = moment().startOf("day").subtract(15, "day");
        break
    }
    for (var element of data) {
      ...
      if (moment.isMoment(elementDate)) {
        ...
        commissionData[index] = element.totalCommission;
      }
    }
    return [
      {
...
export default AffiliateCommissionChart;